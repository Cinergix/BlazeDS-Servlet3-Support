package com.cinergix.servlet3.endpoint.amf;
...
public class SerializationFilter extends flex.messaging.endpoints.amf.SerializationFilter {
    // Error codes.
     ...
     * @throws IOException
     */
    public static void handleDeserializationException(ActionContext actionContext,
            Throwable t, Logger logger) throws IOException {
        if (t instanceof EOFException) {
            ...
            if (actionContext.getRequestMessage() != null) {
            ...
            if (actionContext.getResponseMessage() != null) {
